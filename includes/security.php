 ...
 */
function require_auth($required_role = null, $redirect_url = null) {
    init_secure_session();
    ...
    if (!validate_session()) {
        ...
        set_security_headers();
        safe_redirect($redirect_url ?? app_base_path() . '/login.php', app_base_path() . '/login.php');
    }
    ...
    if ($required_role && isset($_SESSION['role']) && $_SESSION['role'] !== $required_role) {
        ...
        set_security_headers();
        safe_redirect(app_base_path() . '/unauthorized.php', '/unauthorized.php');
    }
