...
try {
    ...
    log_security_event('application_status_changed', "Application {$application_id}: {$application['current_status']} -> {$new_status}");
    ...
    safe_redirect($redirect_url, "view_applicants.php?job_id={$application['job_id']}");
