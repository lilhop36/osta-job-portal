    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row mb-4">
                <div class="col-md-2">
                    <div class="stat-card">
                        <div class="stat-number text-osta-green"><?= $stats['total'] ?></div>
                ...
                <div class="col-md-2">
                    <div class="stat-card">
                        <div class="stat-number text-success"><?= $stats['accepted'] ?></div>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <?php if ($app['resume_path']): ?>
                                                        <a href="download_document.php?id=<?= $app['id'] ?>&type=resume"
